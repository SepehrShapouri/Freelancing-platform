  ...
  return (
    <div className="dark:bg-slate-700 w-full h-full bg-blue-50 p-4 flex flex-col items-center gap-4 ">
      ...
      {isLoading ? (
        ...
        <div className="w-[400px] bg-white shadow-xl rounded-xl h-[400px]  dark:bg-slate-600">
          <form
            onSubmit={handleSubmit(handleUpdate)}
            className="p-7 flex flex-col gap-y-6"
          >
            <CompleteProfileInput name="name" register={register} label="نام" />
